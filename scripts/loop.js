...
function loop() {
    ...
    if (lVA == 1) {
        ...
        if (lctr > 1 && level == 2 && tP.indexOf(0) == -1) {
            message("Level 3 Complete!", "We haven't added the next level yet :(")
            levelC[2] = 1;
            endLevel();
        }
        if (level == 2) {
        ...
        while (ctr < xE.length) {
            ...
            if (Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) > 512) {
                ...
                ctx.lineWidth = 10;
                ctx.moveTo((Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 360) * Math.cos(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512, (Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 360) * Math.sin(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512);
                ctx.lineTo((Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 380) * Math.cos(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512, (Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 380) * Math.sin(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512);
                ctx.stroke();
                ctx.textAlign = "center";
                ...
                ctx.lineWidth = 4;
                ctx.strokeStyle = "rgb(40, 40, 40)";
                ctx.strokeText(Math.round(Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2))), (Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 360) * Math.cos(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512, (Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 360) * Math.sin(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512);
                ctx.fillText(Math.round(Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2))), (Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 360) * Math.cos(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512, (Math.sqrt(Math.pow(x - xE[ctr], 2) + Math.pow(y - yE[ctr], 2)) / 30 + 360) * Math.sin(Math.atan2(yE[ctr] - y, xE[ctr] - x)) + 512);
            }
            tMRE[ctr]++
            tMRE2[ctr]++
            if (hPE[ctr] <= 0) {
    ...
    if (lVA == 0) {
        ...
        //ctx.strokeText("The First Level", 50 - x + 512, 43 - y + 512);
        //ctx.fillText("The First Level", 50 - x + 512, 43 - y + 512);
        //ctx.strokeText("Very Easy", 50 - x + 512, 66 - y + 512);
        //ctx.fillText("Very Easy", 50 - x + 512, 66 - y + 512);
        //if (levelC[0] == 0) {
        //    ctx.strokeText("Incomplete", 50 - x + 512, 89 - y + 512);
        //    ctx.fillText("Incomplete", 50 - x + 512, 89 - y + 512);
        //} else {
        //    ctx.strokeText("Completed!", 50 - x + 512, 89 - y + 512);
        //    ctx.fillText("Completed!", 50 - x + 512, 89 - y + 512);
        //}
        ...
        if (levelC[0] == 1) {
            ...
            //ctx.font = "Bold 14px Ubuntu";
            //ctx.textAlign = "center";
            //ctx.strokeText("Level 2", 50 - x + 512, 20 - y + 512);
            //ctx.fillText("Level 2", 50 - x + 512, 20 - y + 512);
            //ctx.strokeText("The Enemy Approaches", 50 - x + 512, 43 - y + 512);
            //ctx.fillText("The Enemy Approaches", 50 - x + 512, 43 - y + 512);
            //ctx.strokeText("Very Easy", 50 - x + 512, 66 - y + 512);
            //ctx.fillText("Very Easy", 50 - x + 512, 66 - y + 512);
            //if (levelC[1] == 0) {
            //    ctx.strokeText("Incomplete", 50 - x + 512, 89 - y + 512);
            ...
            //ctx.font = "Bold 14px Ubuntu";
            //ctx.textAlign = "center";
            //ctx.strokeText("Level 3", 50 - x + 512, 20 - y + 512);
            //ctx.fillText("Level 32", 50 - x + 512, 20 - y + 512);
            //ctx.strokeText("Mine the Squares", 50 - x + 512, 43 - y + 512);
            //ctx.fillText("Mine the Squares", 50 - x + 512, 43 - y + 512);
            //ctx.strokeText("Easy", 50 - x + 512, 66 - y + 512);
            //ctx.fillText("Easy", 50 - x + 512, 66 - y + 512);
            //if (levelC[2] == 0) {
            //    ctx.strokeText("Incomplete", 50 - x + 512, 89 - y + 512);
            //    ctx.fillText("Incomplete", 50 - x + 512, 89 - y + 512);
            //} else {
    ...
    if (ctr11 > 0) {
        ...
        ctx.font = "Bold 18px Ubuntu";
        ctx.strokeText(msg, 512, 512);
        ctx.fillText(msg, 512, 512);
        if (msg2 != undefined) {
            ctx.strokeText(msg2, 512, 536);
            ctx.fillText(msg2, 512, 536);
        }
        ctr11++
    }
    if (ctr11 > msgD - 1) {
